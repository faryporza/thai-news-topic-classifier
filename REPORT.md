...
เพื่อแก้ไขปัญหา Mixed Signal ที่โมเดลยังสับสน จึงได้เพิ่ม **Rule-based Override** เข้าไปใน Pipeline:
...
**ผลลัพธ์:** ช่วยลด Error ในกรณีที่ข่าวกำกวม เช่น ข่าวเทคโนโลยีที่มีคำศัพท์ธุรกิจปนอยู่เยอะ
---
